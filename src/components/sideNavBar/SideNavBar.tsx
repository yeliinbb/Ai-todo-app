...
const SideNavBar = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 left-0 bottom-0 mobile:w-[340px] bg-system-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out rounded-e-[48px] ${
