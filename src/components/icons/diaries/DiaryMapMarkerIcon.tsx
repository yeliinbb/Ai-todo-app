const DiaryMapMarkerIcon = ({ onClick }: { onClick?: () => void }) => {
  return (
    <svg
      width="35"
      height="35"
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1645_29802" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1645_29802" result="shape" />
        </filter>
        <clipPath id="clip0_1645_29802">
...
export default DiaryMapMarkerIcon;
