        ...
        <div className="animate-pulse md:w-8/12 flex flex-col justify-center items-center mt-5 h-full">
          ...
          >
            ...
            <ul>
              ...
              <li className="relative min-w-[343px] h-16 flex items-center px-3 py-5 border-b-[1px] border-gray-100 duration-200 text-gray-300 hover:cursor-pointer hover:bg-gray-100 active:bg-gray-200">
                <NicknameSmall />
              ...
              <li className="relative min-w-[343px] h-16 mt-5 flex items-center px-3 py-5 border-b-[1px]  border-gray-100 duration-200 text-gray-800 font-medium text-base hover:cursor-pointer hover:bg-gray-100 active:bg-gray-200">
