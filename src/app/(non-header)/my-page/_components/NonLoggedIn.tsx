...
const NonLoggedIn = () => {
  return (
    <div className="h-[calc(100vh-105px)]">
      ...
      <div
        className={`flex flex-col justify-center relative px-5 py-4 min-w-[347px] min-h-[76px] mt-7 bg-system-white border-2 border-pai-200 rounded-[32px] hover:cursor-pointer duration-200 hover:border-pai-400 active:border-pai-200 active:bg-pai-400 text-gray-400 hover:text-pai-400 active:text-system-white`}
      >
        <Link href={"/login"}>
          <h1 className="text-pai-400 font-extrabold text-lg leading-7 active:text-system-white z-10">
            로그인 하러가기
          </h1>
