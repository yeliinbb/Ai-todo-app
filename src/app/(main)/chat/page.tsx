...
const ChatPage = () => {
  ...
  return (
    <div className="gradient-container w-full h-full rounded-t-[60px] flex flex-col">
      <div className="gradient-rotated">
        <div className="gradient-ellipse w-full h-full"></div>
      </div>
