...
const AiModeToggleSegment = ({ isFai, handleToggleAiMode }: AiModeToggleSegmentProps) => {
  return (
    <div className="w-full bg-gray-200 p-1 flex justify-between items-center rounded-full mb-7 relative">
      ...
      <div className="relative z-10 flex w-full">
        <div
          ...
          className={`flex-1 rounded-full text-center font-extrabold z-10 cursor-pointer ${
        ...
        <div
          onClick={handleToggleAiMode}
          className={`flex-1 text-center font-extrabold z-10 cursor-pointer ${
