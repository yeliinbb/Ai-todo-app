...
const TodoList: React.FC<TodoListProps> = ({ todos, addTodo, updateTodo, deleteTodo }) => {
  ...
  const todayTodos = todos.filter((todo) => !todo.is_done && dayjs(todo.event_datetime).isSame(dayjs(), "day"));
