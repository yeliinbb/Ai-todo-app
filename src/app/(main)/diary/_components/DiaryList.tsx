...
const DiaryList: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`bg-gray-100 box-border relative top-[5.375rem] ${isDesktop ? "h-[calc(100vh-5.375rem)] flex justify-center gap-10" : "flex flex-col h-[calc(100dvh-5.375rem)] gap-6"}`}
      >
        <Calendar
          ...
          color="fai"
          events={diaryAllData}
          className="desktop:h-full desktop:flex desktop:items-center desktop:justify-center desktop:ml-[2.25rem] desktop:pb-[100px] desktop:max-w-[31.8rem] w-full"
        />

        <div className={`bg-gray-100 ${isDesktop ? "h-full w-full" : "flex-grow"}`}>
          <div
