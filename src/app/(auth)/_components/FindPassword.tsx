      ...
      {!isEmailSend ? (
        <div className="relative flex flex-col justify-center items-center mb-8">
          ...
          <form className="md:w-8/12 flex flex-col justify-center text-base" onSubmit={handleSubmitEmail}>
            <InputBox
              ...
              error={error}
            />
            <div className="absolute top-96 translate-y-[50px] flex justify-between gap-2.5">
        ...
        <div className="relative flex flex-col items-center mb-8">
          ...
          <div
            ...
            className="min-w-[263px] min-h-11 z-10 flex justify-center items-center hover:cursor-pointer text-sm text-gray-600 font-medium mt-[205px]"
          >
