...
const SubmitBtn = ({ text, type, isDisabled, isLoading }: Propstype) => {
  ...
  return (
    <button
      ...
      ref={buttonRef}
      disabled={isDisabled}
      className={`desktop:text-lg desktop:w-[580px] desktop:border-none flex justify-center items-center min-w-[343px] min-h-[52px] mt-14 px-7 py-3 rounded-[28px] text-base font-extrabold text-system-white hover:border hover:border-paiTrans-60032 ${backgroundColor} ${
