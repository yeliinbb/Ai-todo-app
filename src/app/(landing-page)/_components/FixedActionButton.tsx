...
const FixedActionButton = () => {
  return (
    <div className="sticky bottom-0 left-0 right-0  px-4 py-5">
      <Link
        href={"/todo-list"}
        className="mobile:w-[calc(100%-32px)] mobile:mx-auto desktop:w-[300px] desktop:mx-auto h-[48px] bg-gradient-pai400-fai500-br rounded-full flex flex-row items-center"
      >
