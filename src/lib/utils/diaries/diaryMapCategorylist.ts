import { CategoryCode, MapType } from "@/types/diary.type";

export const categoryList: { code: CategoryCode; keyWord: string }[] = [
  ...
  export const mapTypes: { id: MapType; label: string }[] = [
